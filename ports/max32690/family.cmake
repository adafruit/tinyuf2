...
function(family_add_board_target BOARD_TARGET)
  ...
  add_library(${BOARD_TARGET} STATIC
    ${MAX32_LIB}/CMSIS/Device/Maxim/${MAX_DEVICE_UPPER}/Source/GCC/startup_${MAX_DEVICE}.S
    ${MAX32_LIB}/CMSIS/Device/Maxim/${MAX_DEVICE_UPPER}/Source/heap.c
    ${MAX32_LIB}/CMSIS/Device/Maxim/${MAX_DEVICE_UPPER}/Source/system_${MAX_DEVICE}.c
    ...
    ${MAX32_LIB}/PeriphDrivers/Source/SYS/pins_${PERIPH_SUFFIX}${PERIPH_ID}.c
    ${MAX32_LIB}/PeriphDrivers/Source/SYS/sys_${PERIPH_SUFFIX}${PERIPH_ID}.c
    ${MAX32_LIB}/PeriphDrivers/Source/FLC/flc_common.c
    ${MAX32_LIB}/PeriphDrivers/Source/FLC/flc_${PERIPH_SUFFIX}${PERIPH_ID}.c
    ${MAX32_LIB}/PeriphDrivers/Source/FLC/flc_reva.c
    ${MAX32_LIB}/PeriphDrivers/Source/GPIO/gpio_common.c
    ${MAX32_LIB}/PeriphDrivers/Source/GPIO/gpio_${PERIPH_SUFFIX}${PERIPH_ID}.c
    ${MAX32_LIB}/PeriphDrivers/Source/GPIO/gpio_reva.c
    ${MAX32_LIB}/PeriphDrivers/Source/ICC/icc_${PERIPH_SUFFIX}${PERIPH_ID}.c
    ${MAX32_LIB}/PeriphDrivers/Source/ICC/icc_reva.c
    ${MAX32_LIB}/PeriphDrivers/Source/UART/uart_common.c
    ${MAX32_LIB}/PeriphDrivers/Source/UART/uart_${PERIPH_SUFFIX}${PERIPH_ID}.c
    )
  target_include_directories(${BOARD_TARGET} PUBLIC
    ...
    ${MAX32_LIB}/CMSIS/Device/Maxim/${MAX_DEVICE_UPPER}/Include
    ${MAX32_LIB}/PeriphDrivers/Include/${MAX_DEVICE_UPPER}
  ...
  if (${MAX_DEVICE} STREQUAL "max32650" OR
    ...
    target_sources(${BOARD_TARGET} PRIVATE
      ${MAX32_LIB}/PeriphDrivers/Source/ICC/icc_common.c
      ${MAX32_LIB}/PeriphDrivers/Source/TPU/tpu_${PERIPH_SUFFIX}${PERIPH_ID}.c
      ${MAX32_LIB}/PeriphDrivers/Source/TPU/tpu_reva.c
      ${MAX32_LIB}/PeriphDrivers/Source/UART/uart_reva.c
      )
    target_include_directories(${BOARD_TARGET} PUBLIC
      ${MAX32_LIB}/PeriphDrivers/Source/TPU
      )
  elseif (${MAX_DEVICE} STREQUAL "max32690")
    target_sources(${BOARD_TARGET} PRIVATE
      ${MAX32_LIB}/PeriphDrivers/Source/CTB/ctb_${PERIPH_SUFFIX}${PERIPH_ID}.c
  ...
  elseif (${MAX_DEVICE} STREQUAL "max78002")
    target_sources(${BOARD_TARGET} PRIVATE
      ${MAX32_LIB}/PeriphDrivers/Source/AES/aes_${PERIPH_SUFFIX}${PERIPH_ID}.c
      ${MAX32_LIB}/PeriphDrivers/Source/AES/aes_revb.c
      ${MAX32_LIB}/PeriphDrivers/Source/TRNG/trng_${PERIPH_SUFFIX}${PERIPH_ID}.c
      ${MAX32_LIB}/PeriphDrivers/Source/TRNG/trng_revb.c
      ${MAX32_LIB}/PeriphDrivers/Source/UART/uart_revb.c
      )
    target_include_directories(${BOARD_TARGET} PUBLIC
      ${MAX32_LIB}/PeriphDrivers/Source/AES
      ${MAX32_LIB}/PeriphDrivers/Source/TRNG
      )
  else()
    message(FATAL_ERROR "Unsupported MAX device: ${MAX_DEVICE}")
  endif()
