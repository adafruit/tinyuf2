...
const ivt image_vector_table = {
  ...
  (uint32_t)0x2020650D,               /* Image Entry Function */
  IVT_RSVD,                           /* Reserved = 0 */
...
const BOOT_DATA_T boot_data = {
  (uint32_t)&image_vector_table,  /* boot start location */
  0xA8000,                        /* size 0x2021000 - 0x20205800 */
  0x0,                            /* Plugin flag */
  0x0                             /* empty - extra data word */
};

/* Remove FCB for testing in RAM */
