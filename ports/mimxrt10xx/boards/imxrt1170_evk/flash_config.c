...
const flexspi_nor_config_t qspiflash_config = {
    ...
    .memConfig =
    {
        ...
        .serialClkFreq = 7,  // 133MHz for RT1170 (kFlexSpiSerialClk_133MHz has wrong value in header)
        ...
        .lookupTable =
        {
            ...
            SEQUENCE(FLEXSPI_LUT_SEQ(CMD_SDR,   FLEXSPI_1PAD, 0x31  /* Write Status Register-2 */,
